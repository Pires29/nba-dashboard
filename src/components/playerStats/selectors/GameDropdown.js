...
const GameDropdown = ({ team1Id, team2Id, games, teams, onSelect }) => {
  ...
  return (
    <label className="block">
      ...
      <div className="overflow-hidden rounded-lg border border-white/[0.08] bg-[#060E1A] transition-colors hover:border-orange-500/30 focus-within:border-orange-500/40">
        ...
        <div className="border-t border-white/[0.08] px-3 py-1">
