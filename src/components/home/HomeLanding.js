    ...
    <div className="overflow-hidden scroll-smooth bg-[#060b13] text-white">
      ...
      <section className="relative mx-auto max-w-[1240px] px-6 pb-20 pt-20 sm:pt-28 lg:pb-28">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row"><a href="/props" className="w-full rounded-xl bg-orange-500 px-7 py-3.5 text-center font-mono text-xs font-black uppercase tracking-widest text-white shadow-[0_0_35px_rgba(249,115,22,.28)] transition hover:bg-orange-400 sm:w-auto">Open Props Table</a><a href="#pricing" className="w-full rounded-xl border border-white/10 bg-white/[0.03] px-7 py-3.5 text-center font-mono text-xs font-bold uppercase tracking-widest text-slate-300 transition hover:border-white/20 hover:text-white sm:w-auto">Start 7-Day Trial</a></div>
      ...
      <FaqSection />
      <section className="relative px-6 py-24 text-center"><div className="absolute left-1/2 top-1/2 h-52 w-96 -translate-x-1/2 -translate-y-1/2 rounded-full bg-orange-500/10 blur-[100px]" /><div className="relative"><p className="font-mono text-[10px] uppercase tracking-[0.25em] text-orange-400">Your next slate starts here</p><h2 className="mx-auto mt-5 max-w-3xl text-4xl font-black tracking-tight sm:text-6xl">Stop guessing. Start researching.</h2><div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row"><a href="/props" className="inline-flex items-center justify-center rounded-xl bg-orange-500 px-7 py-3.5 font-mono text-xs font-black uppercase leading-none tracking-widest hover:bg-orange-400">Explore NBA Props</a><a href="#pricing" className="inline-flex items-center justify-center rounded-xl border border-white/10 px-7 py-3.5 font-mono text-xs font-bold uppercase leading-none tracking-widest text-slate-300 hover:border-white/20">Start Free Trial</a></div></div></section>
