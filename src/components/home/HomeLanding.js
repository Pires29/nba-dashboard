    ...
    <div className="overflow-hidden bg-[#060b13] text-white">
      ...
      <section className="relative mx-auto max-w-[1240px] px-6 pb-20 pt-20 sm:pt-28 lg:pb-28">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <h1 className="text-5xl font-black leading-[1.08] tracking-normal sm:text-7xl sm:leading-[1.02] lg:text-[84px]">Research every prop.<span className="block pb-1 bg-gradient-to-r from-orange-400 via-amber-300 to-orange-500 bg-clip-text text-transparent">Find your edge.</span></h1>
