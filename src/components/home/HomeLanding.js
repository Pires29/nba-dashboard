    ...
    <div className="overflow-hidden bg-[#060b13] text-white">
      ...
      <section className="relative mx-auto max-w-[1240px] px-6 pb-20 pt-20 sm:pt-28 lg:pb-28">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <h1 className="text-5xl font-black leading-[0.96] tracking-[-0.045em] sm:text-7xl lg:text-[84px]">Research every prop.<span className="block bg-gradient-to-r from-orange-400 via-amber-300 to-orange-500 bg-clip-text text-transparent">Find your edge.</span></h1>
